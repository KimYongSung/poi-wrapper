...
public final class PoiWriterBuilder{
	...
	public PoiWriter build(){
		...
		CellStyle titleStyle = titleBuilder == null? DefaultCellStyles.defaultTitleBuilder.build(workBook) : titleBuilder.build(workBook);
		CellStyle numberStyle = numberBuilder == null ? DefaultCellStyles.defaultNumberBuilder.build(workBook) : numberBuilder.build(workBook);
		CellStyle stringStyle = stringBuilder == null ? DefaultCellStyles.defaultStringBuilder.build(workBook) : stringBuilder.build(workBook);
		
		return new PoiWriter(maxrow, workBook, outputStream, titleStyle, numberStyle, stringStyle);
	}
