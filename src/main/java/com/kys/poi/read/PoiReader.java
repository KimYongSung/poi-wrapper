 ...
 * <br>
 * <br>
 * <strong>.xlsx 확장자만 가능 합니다.</strong>
 * <br>
 * 
 * @author kys0213
 * @date   2019. 3. 25.
...
public class PoiReader implements Closeable{
	...
	public void allSheetRead(PoiRowHandler rowHandler)throws Exception {
		while(hasNextSheet()) read(rowHandler);
	}
	 ...
	 * @throws SAXException
	 */
	private void processSheet(SheetContentsHandler handler, InputStream sheetInputStream) throws IOException, SAXException {
