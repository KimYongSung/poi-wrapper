...
public class StringUtil {
	...
	public static String nullToStr(String str, String replace){
		if(str == null || str.length() == 0) return replace;
		else return str;
	}
	...
	public static String nullToStr(Object str, String nullStr){
		if(ObjectUtils.isNull(str)) return nullStr;
	...
	public static String[] splite(String str, String delimiter){
		...
		if(isNull(str)) return EMPTY_ARR;
	...
	/**
	 * 정수로 변경. 
	 * <br> 정수형이 아니거나 null 일 경우 defaultValue로 변환
	 * @param value
	 * @param defaultValue
	 * @return
	 */
	public static int toInt(String value, int defaultValue){
		if(isNull(value) || !isNumber(value)) return defaultValue;
		return Integer.parseInt(value);
	}

	/**
	 * 정수로 변경. 
	 * <br> 정수형이 아니거나 null 일 경우 -1로 변환
	 * @param value
	 * @param defaultValue
	 * @return
	 */
